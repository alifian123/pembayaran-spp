          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-body">
                ...
                <a href="<?php echo base_url('siswa') ?>" class="btn btn-primary">Data Siswa</a>
              </div>
            </div>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <a href="<?php echo base_url('kelas') ?>" class="btn btn-primary">Data Kelas</a>
          ...
          <div class="col-lg-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Silahkan isi Pembayaran</p>
                <a href="<?php echo base_url('spp/tambah') ?>" class="btn btn-primary">Pembayaran</a>
              </div>
            </div>
