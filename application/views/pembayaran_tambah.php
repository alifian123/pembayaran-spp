                  ...
                  <div class="card-body">
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">ID Pembayaran</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="id_pembayaran" placeholder="ID" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">Tanggal Bayar</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="tgl_bayar" placeholder="Tanggal" required>
                            </div>
                          </div>
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">Bulan Dibayar</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="bulan_dibayar" placeholder="Bulan" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">Tahun Dibayar</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="tahun_dibayar" placeholder="Tahun" required>
                            </div>
                            </div>
                        <div class="form-group row">
